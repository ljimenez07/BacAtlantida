...
<div class="container">
	<form id="agregarOferta-form" method="POST" th:action="@{/${pageContext.request.contextPath}/insertarOferta}" th:object="${oferta}" action="#">
		<div id="agregarOferta">
			<div class="row">
				<div class="col-md-2">
					<div class="form-group">
						<label for="tituloOferta-lbl">Título de oferta*</label>
						<input type="text" class="form-control" name="tituloDeOferta" th:field="*{tituloDeOferta}">
						<!-- <p th:if="${fields.hasErrors('tituloDeOferta')}" th:errors="*{tituloDeOferta}">Título necesario</p> -->
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
						<label for="nombreComercio-lbl">Nombre del comercio*</label>
						<input type="text" class="form-control" name="comercio" th:field="*{comercio}">
					</div>
				</div>
				<div class="col-md-2">
					<div class="form-group">
			...
			<input type="hidden" id="logo-comercio" name="imagenComercioPath">
