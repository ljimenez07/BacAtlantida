...
public class MovilController {
	...
	@ResponseBody String chat(@RequestBody String mensaje, HttpSession session) throws JSONException, JsonParseException, JsonMappingException, IOException, JDOMException 
	{
	...
	@ResponseBody String conocerte(@RequestBody String mensaje, HttpSession session) throws JSONException, JsonParseException, JsonMappingException, IOException, JDOMException 
	{
		Usuario usuario = (Usuario)session.getAttribute(Usuario.LLAVE_EN_SESSION) ;
		if( usuario  == null)
		{
	...
	@ResponseBody String login(@RequestBody String mensaje, HttpSession session, @RequestParam String name, @RequestParam String password) throws JSONException, JsonParseException, JsonMappingException, IOException, JDOMException 
	{
		...
		String responseXML = given().body(requestBody).post("http://localhost:8080/Ecommerce/login/").andReturn().asString();
